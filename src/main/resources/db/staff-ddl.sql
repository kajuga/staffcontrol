...
DROP TABLE staffcontrol.employee;
DROP TABLE staffcontrol.project;
DROP TABLE staffcontrol.team;
DROP TABLE staffcontrol.feedback;


CREATE TABLE staffcontrol.feedback
(
...
CREATE TABLE staffcontrol.team
(
